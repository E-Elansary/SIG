...
import com.sales.controller.Dominator;
...
public class InvoiceFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        createInvoiceButton.setBackground(new java.awt.Color(0, 204, 0));
        ...
        createLineButton.setBackground(new java.awt.Color(0, 153, 0));
        createLineButton.setText("Create New Item");

        deleteLineButton.setBackground(new java.awt.Color(255, 0, 0));
    ...
    private Dominator controller = new Dominator(this);
    private TableReplica invoicesTableModel;
    ...
    public TableReplica getInvoicesTableModel() {
        if (invoicesTableModel == null) {
            invoicesTableModel = new TableReplica(getInvoices());
        }
        return invoicesTableModel;
    }

    public void setInvoicesTableModel(TableReplica invoicesTableModel) {
    ...
    public Dominator getController() {
        return controller;
    }
